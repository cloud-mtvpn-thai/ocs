...
read -p "Nama Database: " -e -i MT_VPN DatabaseName
echo ""
...
curl $sourcWillye/ocs/nginx.conf > /etc/nginx/nginx.conf
...
chmod 777 /home/fns/public_html/config/config.inc.php
...
chmod 644 /home/fns/public_html/config/config.inc.php
